...
<html lang="es">
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <h1><img class="logologin" src="Assets\images\Logo2.svg" alt=""></h1>
        <a href="https://troncosdelivery.com/"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Regresar</a>
        <style>
        .logo h1{
            font:Poppins;
            color: white;
