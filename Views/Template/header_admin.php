...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="TRONCOS DELIVERY">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard"><img class="headerlogo" src="Assets\tienda\images/Logo2.svg" alt=""></a>
